                    ...
                    <div className="col-6 padded borded header">
                        <Fade duration={200}>
                            <div className="d-flex justify-content-between align-baseline">
                                ...
                                <div className="white-color d-flex gap-2 align-items-end" style={{ filter: dataElement?.super.refresh ? `invert(${percentageValueSuper}%)` : 'invert(0%)' }}>
                                    <p className="mb-1">THREAT RATING:</p>
                                    <h2>{dataElement?.super.threatRating}</h2>
                                </div>
                            </div>
                        </Fade>
                    </div>
                    ...
                    <div className="col-6 padded text-center white-color footer">
                        <Fade duration={200}>
                            <div style={{ filter: dataElement?.omnidroid.refresh ? `invert(${percentageValueSuper}%)` : 'invert(0%)' }}>
                                <h1 className="mb-2 text-uppercase footer-h1">OMNIDROID v.{dataElement?.omnidroid.name}</h1>
                                <p className="text-uppercase">
