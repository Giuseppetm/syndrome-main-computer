        ...
        <div className="search-super-result-frame">
            <div className="container-fluid h-100">
                <div className="row h-100">
                    <div className="col-5 padded borded header" />

                    <div className="col-7 padded header" />

                    <div className="col-5 p-0 padded borded content image">
                        <Fade duration={200}>
                            <img id="super-image" src={require('../Images/Search Results/' + superResult?.img)} alt={superResult?.img} />
                        </Fade>
                    </div>

                    <div className="col-7 padded result content">
                        <Fade duration={200}>
                            <div className="mb-3">
                    ...
                    <div className="col-5 padded borded footer" />

                    <div className="col-7 padded footer" />
                </div>
