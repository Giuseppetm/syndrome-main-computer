...
export const supers: Array<Super> = [
  ...
  { name: 'Metaman', slug: 'metaman', threatRating: 8.9, description: 'Flight, super strength, x-ray vision, magnetic manipulation, teleportation, invisibility', img: 'metaman.png' },
  { name: 'Mr. Incredible', slug: 'mr-incredible', threatRating: 9.1, description: 'Superhuman strength, capable of lifting weight up to 55 tons, invulnerability to high levels of physical damage', img: 'mr_incredible.png' },
]
